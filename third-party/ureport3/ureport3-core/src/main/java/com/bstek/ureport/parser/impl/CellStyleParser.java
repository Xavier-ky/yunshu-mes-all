...
public class CellStyleParser implements Parser<CellStyle> {
	...
	public CellStyle parse(Element element) {
		...
		if(StringUtils.hasText(forConditionText)){
		...
		if(StringUtils.hasText(forecolor)){
		...
		if(StringUtils.hasText(wrapCompute)){

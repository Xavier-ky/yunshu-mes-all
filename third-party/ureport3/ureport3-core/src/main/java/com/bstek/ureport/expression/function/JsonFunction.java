...
public class JsonFunction implements Function {
	...
	public Object execute(List<ExpressionData<?>> dataList, Context context,Cell currentCell){
		...
		if(obj==null || property==null || obj.isEmpty() || property.isEmpty()){
			return null;
		}
	...
	private String buildData(ExpressionData<?> exprData) {
		String obj=null;
		if(exprData instanceof ObjectExpressionData objData){
            Object data=objData.getData();
			if(data!=null){
				obj=data.toString();
			}
		}else if(exprData instanceof ObjectListExpressionData listData){
		...
		}else if(exprData instanceof BindDataListExpressionData listData){

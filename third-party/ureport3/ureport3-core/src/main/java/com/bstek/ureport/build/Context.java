...
public class Context {
	...
	public Map<String,String> getMapping(DatasetExpression expr){
		if(expr.getMappingType().equals(MappingType.simple)){
			...
			if(StringUtils.hasText(expr.getMappingDataset()) && StringUtils.hasText(expr.getMappingKeyProperty()) && StringUtils.hasText(expr.getMappingValueProperty())){
	...
	public List<Cell> nextUnprocessedCells(){
		if(unprocessedCellsMap.isEmpty()){
			return null;
		}

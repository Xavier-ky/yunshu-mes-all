...
public class AvgFunction implements Function {
	...
	public Object execute(List<ExpressionData<?>> dataList, Context context,Cell currentCell) {
		...
		for(ExpressionData<?> exprData:dataList){
			if(exprData instanceof ObjectListExpressionData listExpr){
			...
			}else if(exprData instanceof ObjectExpressionData data){
				...
				total=total.add(bigData);
				size++;
			}else if(exprData instanceof BindDataListExpressionData data){

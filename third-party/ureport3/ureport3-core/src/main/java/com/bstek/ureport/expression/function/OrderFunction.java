...
public class OrderFunction implements Function {
	...
	public Object execute(List<ExpressionData<?>> dataList, Context context,Cell currentCell) {
		...
		if(firstData instanceof ObjectListExpressionData data){
			...
			return list;
		}else if(firstData instanceof BindDataListExpressionData bindDataList){
	...
	private boolean computeOrder(List<ExpressionData<?>> dataList) {
		...
		if(secondData instanceof ObjectExpressionData data){
			...
			if(obj instanceof String){
				order=Boolean.parseBoolean(obj.toString());
			}else{

<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="rqclineList" @selection-change="handleSelectionChange">      
...
<script>
import { listRqcline } from "@/yunshu-ui/api/mes/qc/rqcline";
...
export default {
  ...
  data() {
    return {
      ...
      queryParams: {
        pageNum: 1,
        pageSize: 10,
        rqcId: this.rqcId,        indexId: null,        indexCode: null,        indexName: null,        indexType: null,        qcTool: null,        checkMethod: null,        standerVal: null,        unitOfMeasure: null,        thresholdMax: null,        thresholdMin: null,        crQuantity: null,        majQuantity: null,        minQuantity: null,      },
    };
  },
  created() {
    this.getList();
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listRqcline(this.queryParams).then(response => {
        this.rqclineList = response.rows;

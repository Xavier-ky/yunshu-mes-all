        ...
        <el-row>
            <el-col :span="12">
                <el-form-item label="检测项" prop="indexId">
                    <el-input v-model="form.indexName" readonly="readonly" placeholder="请选择检测项" >
            ...
            <el-col :span="12">
                <el-form-item label="检测工具" prop="qcTool">
                    <el-input v-model="form.qcTool" readonly="readonly" />
                </el-form-item>
            </el-col>
        </el-row>
        <el-row>
...
<script>
import { listTemplateindex, getTemplateindex, delTemplateindex, addTemplateindex, updateTemplateindex } from "@/yunshu-ui/api/mes/qc/templateindex";
import IndexSelect from "@/yunshu-ui/components/qcindexSelect/single.vue";

<template>
  <div class="app-container">
    ...
    <el-table class="yunshu-data-table" stripe border v-loading="loading" :data="ruleList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="规则编码" align="center" width="210px" prop="ruleCode" >
          <template #default="scope">
          <router-link :to="'/app/system/settings?tab=autocode&ruleId=' + scope.row.ruleId" class="link-type">
...
<script>
import { listRule, getRule, delRule, addRule, updateRule } from "@/yunshu-ui/api/system/autocode/rule";

            ...
            <el-col :span="8">
              <el-form-item label="批次号" prop="batchCode">
                <el-input v-model="form.batchCode" readonly="readonly" placeholder="请选择批次号" >
                  <template #append><el-button @click="handleSelectBatch" icon="el-icon-search"></el-button></template>
                </el-input>
              </el-form-item>
              <BatchSelect ref="batchSelect" :itemId="form.itemId" :vendorId="vendorId" @onSelected="onBatchSelected" ></BatchSelect>
            </el-col>
        </el-row>
        <el-row>
            <el-col :span="24">
...
<script>
import { listRtvendorline, getRtvendorline, delRtvendorline, addRtvendorline, updateRtvendorline } from "@/yunshu-ui/api/mes/wm/rtvendorline";

...
<script>
import { listArea, getArea, delArea, addArea, updateArea, changeFrozenState } from "@/yunshu-ui/api/mes/wm/area";
import {genCode} from "@/yunshu-ui/api/system/autocode/rule"
import BarcodeImg from "@/yunshu-ui/components/barcodeImg/index.vue"
import { getLocationName } from "@/yunshu-ui/api/mes/wm/area";
export default {
  name: "WmStorageArea",
  dicts: ['sys_yes_no'],

<template>
  <div class="app-container warehouse-command-center">
    <el-form
      :model="queryParams"
      ref="queryForm"
      size="small"
    ...
    <el-dialog :title="title" v-model="open" width="960px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="10">
            <BarcodeImg
              :bussinessId="form.warehouseId"
              :bussinessCode="form.warehouseCode"
...
import {
  ...
  updateWarehouse,
  changeFrozenState,
} from "@/yunshu-ui/api/mes/wm/warehouse";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        charge: [{ max: 255, message: "字段过长", trigger: "blur" }],
      },
    };
  },
  created() {
  ...
  methods: {
    ...
    handleLocation(warehouseId) {
      this.$router.push({
        ...
        query: { warehouseId: warehouseId || 0, optType: this.optType },
      });
    },

<template>
  <div class="issue-line-root">
    ...
    <el-table v-loading="loading" class="yunshu-data-table" stripe border :data="issuelineList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="物资编码" width="120px" align="center" prop="itemCode" />
      <el-table-column label="物资名称" width="120px"  align="center" prop="itemName" :show-overflow-tooltip="true"/>
            ...
            <el-col :span="8">
                <el-form-item label="产品物料编码" prop="itemCode">
                    <el-input v-model="form.itemCode" readonly="readonly" placeholder="请选择产品物料编码" >
                      <template #append><el-button @click="handleSelectItem" icon="el-icon-search"></el-button></template>
                    </el-input>
                </el-form-item>
...
<script>
import { listIssueline, getIssueline, delIssueline, addIssueline, updateIssueline } from "@/yunshu-ui/api/mes/wm/issueline";

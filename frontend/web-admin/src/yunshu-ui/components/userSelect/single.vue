  ...
  >
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table class="yunshu-data-table" stripe border v-loading="loading" :data="userList" @current-change="handleCurrent" @row-dblclick="handleRowDbClick">
            <el-table-column  width="55" align="center" >
                <template #default="scope">
                    <el-radio v-model="selectedId" :value="scope.row.userId" @change="handleRowChange(scope.row)">{{""}}</el-radio>
                </template>
            </el-table-column>

...
<script>
import { listWorkstationtool, getWorkstationtool, delWorkstationtool, addWorkstationtool, updateWorkstationtool } from "@/yunshu-ui/api/mes/md/workstationtool";
import { listAllTooltype } from "@/yunshu-ui/api/mes/tm/tooltype"
export default {

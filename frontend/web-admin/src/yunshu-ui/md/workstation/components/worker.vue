...
<script>
import { listWorkstationworker, getWorkstationworker, delWorkstationworker, addWorkstationworker, updateWorkstationworker } from "@/yunshu-ui/api/mes/md/workstationworker";
import {listAllPost} from "@/yunshu-ui/api/system/post";
export default {

...
@RestController
@RequestMapping("/api/mes/wm/productrecptdetail")
public class WmProductRecptDetailController {

    private final WmProductRecptService service;

    public WmProductRecptDetailController(WmProductRecptService service) {

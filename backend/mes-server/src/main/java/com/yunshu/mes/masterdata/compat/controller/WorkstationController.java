...
import com.yunshu.mes.masterdata.compat.service.WorkstationService;
...
@RestController
@RequestMapping("/api/mes/md/workstation")
public class WorkstationController {
    ...
    public Map<String, Object> getInfo(@PathVariable Long workstationId) {
        Map<String, Object> row = service.getById(workstationId);
        return row == null ? MesApiResponse.error("工作站不存在") : MesApiResponse.ok(row);
    }
    ...
    public Map<String, Object> remove(@PathVariable String workstationIds) {
        int n = 0;
        for (String p : workstationIds.split(",")) {

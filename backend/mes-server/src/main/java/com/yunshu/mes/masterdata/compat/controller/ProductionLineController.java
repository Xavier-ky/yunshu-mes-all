...
import com.yunshu.mes.masterdata.compat.service.ProductionLineService;
...
@RestController
@RequestMapping("/api/mes/md/line")
public class ProductionLineController {
    ...
    public Map<String, Object> getInfo(@PathVariable Long lineId) {
        ...
        return row == null ? MesApiResponse.error("产线不存在") : MesApiResponse.ok(row);
    }

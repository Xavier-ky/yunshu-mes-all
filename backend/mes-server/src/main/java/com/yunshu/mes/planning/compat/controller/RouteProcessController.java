...
import com.yunshu.mes.planning.compat.service.RouteProcessService;
import com.yunshu.mes.process.compat.service.ProRouteProcessService;
...
@RestController
@RequestMapping("/api/mes/pro/routeprocess")
public class RouteProcessController {

    private final ProRouteProcessService service;
    private final RouteProcessService legacyService;

    public RouteProcessController(ProRouteProcessService service, RouteProcessService legacyService) {
    ...
    public Map<String, Object> listProductProcess(@PathVariable Long productId) {
        List<Map<String, Object>> rows = legacyService.listProductProcess(productId);

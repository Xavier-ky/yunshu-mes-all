...
@RestController
@RequestMapping("/api/mes/wm/itemconsume")
public class WmItemConsumeController {
    ...
    public WmItemConsumeController(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
    ...
    public Map<String, Object> list(@RequestParam Map<String, String> params) {
        ...
        List<Map<String, Object>> rows = WmSqlHelper.list(jdbc, "wm_item_consume", "record_id", SCHEMA,
                MdDocSchemas.filter(params, "feedbackId"), PageUtil.offset(pn, ps), ps);
        return MesApiResponse.table(rows, WmSqlHelper.count(jdbc, "wm_item_consume", SCHEMA,

...
@RestController
@RequestMapping("/api/mes/wm/productsalesdetail")
public class WmProductSalesDetailController {

    private final WmProductSalesService service;

    public WmProductSalesDetailController(WmProductSalesService service) {

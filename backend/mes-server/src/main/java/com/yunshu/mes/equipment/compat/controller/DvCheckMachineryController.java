...
@RestController
@RequestMapping("/api/mes/dv/checkmachinery")
public class DvCheckMachineryController {

    private final DvCheckMachineryRepository repo;

    public DvCheckMachineryController(DvCheckMachineryRepository repo) {
        this.repo = repo;
    }

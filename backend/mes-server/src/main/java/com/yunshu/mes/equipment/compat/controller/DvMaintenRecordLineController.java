...
@RestController
@RequestMapping("/api/mes/dv/maintenrecordline")
public class DvMaintenRecordLineController {

    private final DvMaintenRecordLineRepository repo;

    public DvMaintenRecordLineController(DvMaintenRecordLineRepository repo) {
        this.repo = repo;
    }
    ...
    public Map<String, Object> getInfo(@PathVariable Long lineId) {
        return repo.findById(lineId)
                ...
                .orElseGet(() -> MesApiResponse.error("保养行不存在"));
    }

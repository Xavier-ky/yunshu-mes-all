...
import com.yunshu.mes.equipment.compat.repository.DvMaintenRecordLineRepository;
import com.yunshu.mes.equipment.compat.repository.DvMaintenRecordRepository;
...
@RestController
@RequestMapping("/api/mes/dv/maintenrecord")
public class DvMaintenRecordController {

    private final DvMaintenRecordRepository recordRepo;
    private final DvMaintenRecordLineRepository lineRepo;
    private final DvCheckSubjectRepository subjectRepo;

    public DvMaintenRecordController(DvMaintenRecordRepository recordRepo,
                                     DvMaintenRecordLineRepository lineRepo,
    ...
    public Map<String, Object> getInfo(@PathVariable Long recordId) {
        return recordRepo.findById(recordId)
                ...
                .orElseGet(() -> MesApiResponse.error("保养记录不存在"));
    }
